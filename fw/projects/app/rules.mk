# Modified rules from libopencm3 project
### REQUIRED ###
# OPENCM3_DIR - duh
# PROJECT - will be the basename of the output elf, eg usb-gadget0-stm32f4disco
# SOURCES - path to directory where CFILES are located
# MX_PATH - path to stm32cubemx install folder
# MX2BOARD - path to mx2board executable
# MX_PROJECT - path to stm32cubemx project
# BOARD_GPIO_FILE - path to which board file will be generated from stm32cubemx
# CFILES - files to build without $(SOURCES) path
...
all: $(BOARD_GPIO_FILE) $(PROJECT).elf $(PROJECT).bin size
flash: $(PROJECT).flash
